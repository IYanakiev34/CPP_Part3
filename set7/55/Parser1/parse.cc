// Generated by Bisonc++ V6.04.03 on Tue, 28 Mar 2023 18:28:31 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 2}, // 1: start ->  prompt commands
     {261, 2}, // 2: commands ->  commands command
     {261, 1}, // 3: commands ->  command
     {262, 1}, // 4: command ('\x0a') ->  '\x0a'
     {262, 3}, // 5: command ('m') ->  'm' number nextPrompt
     {262, 3}, // 6: command ('s') ->  's' number nextPrompt
     {262, 2}, // 7: command ->  score nextPrompt
     {265, 1}, // 8: score ->  number
     {265, 2}, // 9: score (INTEGRAL) ->  number INTEGRAL
     {263, 1}, // 10: number (DOUBLE) ->  DOUBLE
     {263, 1}, // 11: number (INTEGRAL) ->  INTEGRAL
     {260, 0}, // 12: prompt ->  <empty>
     {264, 2}, // 13: nextPrompt ('\x0a') ->  '\x0a' prompt
     {266, 1}, // 14: start_$ ->  start
};
