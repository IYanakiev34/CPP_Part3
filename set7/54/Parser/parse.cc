// Generated by Bisonc++ V6.04.03 on Tue, 28 Mar 2023 09:29:30 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 3}, // 3: list (WORD) ->  WORD WORD plain
     {258, 4}, // 4: list (WORD) ->  WORD ',' WORD separated
     {259, 2}, // 5: plain (WORD) ->  plain WORD
     {259, 0}, // 6: plain ->  <empty>
     {260, 3}, // 7: separated (',') ->  separated ',' WORD
     {260, 0}, // 8: separated ->  <empty>
     {261, 1}, // 9: list_$ ->  list
};
