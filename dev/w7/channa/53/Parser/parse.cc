// Generated by Bisonc++ V6.04.03 on Mon, 27 Mar 2023 11:55:28 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 1}, // 6: expr ->  indexedExpr
     {260, 2}, // 7: indexedExpr ->  indexable indexedList
     {261, 1}, // 8: indexable (VAR) ->  VAR
     {261, 1}, // 9: indexable (NR) ->  NR
     {262, 1}, // 10: indexedList ->  oneIndex
     {262, 2}, // 11: indexedList ->  indexedList oneIndex
     {263, 3}, // 12: oneIndex ('[') ->  '[' index ']'
     {264, 1}, // 13: index (VAR) ->  VAR
     {264, 1}, // 14: index (NR) ->  NR
     {265, 1}, // 15: expr_$ ->  expr
};
