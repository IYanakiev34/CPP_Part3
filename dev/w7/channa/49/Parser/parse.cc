// Generated by Bisonc++ V6.04.03 on Mon, 27 Mar 2023 10:30:13 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: opt_write_calls ->  opt_write_calls write_call
     {260, 0}, // 2: opt_write_calls ->  <empty>
     {261, 4}, // 3: write_call (WRITE) ->  WRITE '(' args_list ')'
     {262, 3}, // 4: args_list (',') ->  args_list ',' arg
     {262, 1}, // 5: args_list ->  arg
     {263, 1}, // 6: arg (IDENT) ->  IDENT
     {263, 1}, // 7: arg (NUMBER) ->  NUMBER
     {264, 1}, // 8: opt_write_calls_$ ->  opt_write_calls
};
