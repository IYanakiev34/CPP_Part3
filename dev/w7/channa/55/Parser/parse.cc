// Generated by Bisonc++ V6.04.03 on Tue, 28 Mar 2023 09:41:12 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: commands ->  commands prompt_command
     {260, 1}, // 2: commands ->  prompt_command
     {261, 2}, // 3: prompt_command ->  prompt command
     {263, 1}, // 4: command (EMPTY) ->  EMPTY
     {263, 1}, // 5: command ->  mean
     {263, 1}, // 6: command ->  stddev
     {263, 1}, // 7: command ->  score
     {264, 2}, // 8: mean ('m') ->  'm' DOUBLE
     {265, 2}, // 9: stddev ('s') ->  's' DOUBLE
     {266, 1}, // 10: score (DOUBLE) ->  DOUBLE
     {266, 2}, // 11: score (DOUBLE) ->  DOUBLE INTEGRAL
     {262, 0}, // 12: prompt ->  <empty>
     {267, 1}, // 13: commands_$ ->  commands
};
