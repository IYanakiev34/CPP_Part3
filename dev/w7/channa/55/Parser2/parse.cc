// Generated by Bisonc++ V6.04.03 on Tue, 28 Mar 2023 18:34:13 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: commands ->  commands command
     {260, 1}, // 2: commands ->  command
     {261, 1}, // 3: command (EMPTY) ->  EMPTY
     {261, 3}, // 4: command ('m') ->  'm' number '\x0a'
     {261, 3}, // 5: command ('s') ->  's' number '\x0a'
     {261, 2}, // 6: command ('\x0a') ->  score '\x0a'
     {263, 1}, // 7: score (DOUBLE) ->  DOUBLE
     {263, 2}, // 8: score (DOUBLE) ->  DOUBLE INTEGRAL
     {262, 1}, // 9: number (DOUBLE) ->  DOUBLE
     {262, 1}, // 10: number (INTEGRAL) ->  INTEGRAL
     {264, 1}, // 11: commands_$ ->  commands
};
