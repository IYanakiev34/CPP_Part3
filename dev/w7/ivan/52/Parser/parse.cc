// Generated by Bisonc++ V6.04.03 on Sun, 26 Mar 2023 00:09:19 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 1}, // 1: expr (NUMBER) ->  NUMBER
     {260, 2}, // 2: expr (UMINUS) ->  '-' expr
     {260, 3}, // 3: expr ('+') ->  expr '+' expr
     {260, 3}, // 4: expr ('*') ->  expr '*' expr
     {260, 3}, // 5: expr ('^') ->  expr '^' expr
     {260, 3}, // 6: expr (NOTEQ) ->  expr NOTEQ expr
     {261, 1}, // 7: expr_$ ->  expr
};
