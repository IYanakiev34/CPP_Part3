// Generated by Bisonc++ V6.04.03 on Sun, 26 Mar 2023 00:23:59 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {259, 1}, // 1: expr (NUMBER) ->  NUMBER
     {259, 2}, // 2: expr (IDENT) ->  IDENT index
     {259, 2}, // 3: expr ('-') ->  '-' expr
     {259, 4}, // 4: expr ('+') ->  expr '+' expr '\x0a'
     {259, 3}, // 5: expr ('*') ->  expr '*' expr
     {260, 4}, // 6: index ('[') ->  index '[' NUMBER ']'
     {260, 0}, // 7: index ->  <empty>
     {261, 1}, // 8: expr_$ ->  expr
};
