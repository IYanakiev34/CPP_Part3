// Generated by Bisonc++ V6.04.03 on Sat, 25 Mar 2023 21:45:14 +0100
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 6}, // 1: write (WRITE) ->  WRITE '(' args ')' NEWLINE write
     {261, 0}, // 2: write ->  <empty>
     {262, 3}, // 3: args (IDENT) ->  IDENT ',' args
     {262, 3}, // 4: args (NUMBER) ->  NUMBER ',' args
     {262, 1}, // 5: args (IDENT) ->  IDENT
     {262, 1}, // 6: args (NUMBER) ->  NUMBER
     {263, 1}, // 7: write_$ ->  write
};
