// Generated by Bisonc++ V6.04.03 on Tue, 28 Mar 2023 03:30:13 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 2}, // 1: optionalList (WORD) ->  WORD list
     {258, 0}, // 2: optionalList ->  <empty>
     {259, 2}, // 3: list (',') ->  ',' cSeparated
     {259, 1}, // 4: list ->  unseparated
     {260, 3}, // 5: cSeparated (WORD) ->  WORD ',' cSeparated
     {260, 1}, // 6: cSeparated (WORD) ->  WORD
     {261, 2}, // 7: unseparated (WORD) ->  WORD unseparated
     {261, 1}, // 8: unseparated (WORD) ->  WORD
     {262, 1}, // 9: optionalList_$ ->  optionalList
};
