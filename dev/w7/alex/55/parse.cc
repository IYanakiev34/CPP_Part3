// Generated by Bisonc++ V6.04.03 on Tue, 28 Mar 2023 14:57:59 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: start ->  prompt commands
     {262, 2}, // 2: commands ->  commands command
     {262, 1}, // 3: commands ->  command
     {261, 0}, // 4: prompt ->  <empty>
     {263, 1}, // 5: command (NEWLINE) ->  NEWLINE
     {263, 4}, // 6: command ('m') ->  'm' DOUBLE NEWLINE prompt
     {263, 4}, // 7: command ('s') ->  's' DOUBLE NEWLINE prompt
     {263, 3}, // 8: command (NEWLINE) ->  score NEWLINE prompt
     {264, 1}, // 9: score (DOUBLE) ->  DOUBLE
     {264, 2}, // 10: score (DOUBLE) ->  DOUBLE INTEGRAL
     {265, 1}, // 11: start_$ ->  start
};
