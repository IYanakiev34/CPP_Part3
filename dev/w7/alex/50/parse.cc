// Generated by Bisonc++ V6.04.03 on Mon, 27 Mar 2023 19:53:14 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 3}, // 1: Expression ('+') ->  Expression '+' Expression
     {260, 3}, // 2: Expression ('-') ->  Expression '-' Expression
     {260, 3}, // 3: Expression ('*') ->  Expression '*' Expression
     {260, 3}, // 4: Expression ('/') ->  Expression '/' Expression
     {260, 2}, // 5: Expression (UMINUS) ->  '-' Expression
     {260, 2}, // 6: Expression (UMINUS) ->  OPERATION Expression
     {260, 1}, // 7: Expression (NUMBER) ->  NUMBER
     {260, 3}, // 8: Expression ('(') ->  '(' Expression ')'
     {261, 1}, // 9: Expression_$ ->  Expression
};
