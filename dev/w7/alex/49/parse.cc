// Generated by Bisonc++ V6.04.03 on Mon, 27 Mar 2023 16:06:47 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 2}, // 1: Writes ->  Write Writes
     {260, 0}, // 2: Writes ->  <empty>
     {261, 4}, // 3: Write (WRITE) ->  WRITE '(' OptionalParams ')'
     {262, 1}, // 4: OptionalParams ->  Params
     {262, 0}, // 5: OptionalParams ->  <empty>
     {263, 3}, // 6: Params (',') ->  Param ',' Params
     {263, 1}, // 7: Params ->  Param
     {264, 1}, // 8: Param (IDENTIFIER) ->  IDENTIFIER
     {264, 1}, // 9: Param (NUMBER) ->  NUMBER
     {265, 1}, // 10: Writes_$ ->  Writes
};
