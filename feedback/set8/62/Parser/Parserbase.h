// Generated by Bisonc++ V6.04.03 on Mon, 03 Apr 2023 17:33:34 +0200
...
struct TagOf<Rules>
{
    static Tag_ const tag = Tag_::RULES;
};

template <>
struct TagOf<Rule>
{
    static Tag_ const tag = Tag_::RULE;
};

template <>
struct TagOf<std::vector<Production>>
{
    static Tag_ const tag = Tag_::PRODUCS;
};

template <>
struct TagOf<Production>
{
    static Tag_ const tag = Tag_::PRODUC;
};
...
template <>
struct TypeOf<Tag_::RULES>
{
    typedef Rules type;
};

template <>
struct TypeOf<Tag_::RULE>
{
    typedef Rule type;
};

template <>
struct TypeOf<Tag_::PRODUCS>
{
    typedef std::vector<Production> type;
};

template <>
struct TypeOf<Tag_::PRODUC>
{
    typedef Production type;
};
...
// $insert polymorphicOpAssignDecl
        SType &operator=(Rules const &value);
        SType &operator=(Rules &&tmp);

        SType &operator=(Rule const &value);
        SType &operator=(Rule &&tmp);

        SType &operator=(std::vector<Production> const &value);
        SType &operator=(std::vector<Production> &&tmp);

        SType &operator=(Production const &value);
        SType &operator=(Production &&tmp);
...
inline SType &SType::operator=(Rules const &value)
{
    assign< Tag_::RULES >(value);
    return *this;
}
inline SType &SType::operator=(Rules &&tmp)
{
    assign< Tag_::RULES >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(Rule const &value)
{
    assign< Tag_::RULE >(value);
    return *this;
}
inline SType &SType::operator=(Rule &&tmp)
{
    assign< Tag_::RULE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(std::vector<Production> const &value)
{
    assign< Tag_::PRODUCS >(value);
    return *this;
}
inline SType &SType::operator=(std::vector<Production> &&tmp)
{
    assign< Tag_::PRODUCS >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(Production const &value)
{
    assign< Tag_::PRODUC >(value);
    return *this;
}
inline SType &SType::operator=(Production &&tmp)
{
    assign< Tag_::PRODUC >(std::move(tmp));
    return *this;
}
