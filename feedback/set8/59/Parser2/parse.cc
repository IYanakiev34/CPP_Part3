...
PI_ const s_productionInfo[] = 
{
     ...
     {260, 3}, // 1: lines ('\x0a') ->  lines '\x0a' line
     {260, 0}, // 2: lines ->  <empty>
     {261, 1}, // 3: line (INT) ->  INT
     {261, 1}, // 4: line (STRING) ->  STRING
     {261, 1}, // 5: line (DOUBLE) ->  DOUBLE
     {261, 1}, // 6: line ('\x0a') ->  '\x0a'
     {262, 1}, // 7: lines_$ ->  lines
};
...
#line 24 "grammar"
        {
         showInt(vs_(0).get<Tag_::INTEGRAL>());
         }
        break;
...
#line 29 "grammar"
        {
         showStringOrQuit(vs_(0).get<Tag_::STR>());
         }
        break;
...
#line 34 "grammar"
        {
         showDouble(vs_(0).get<Tag_::FLOAT>());
         }
        break;
