...
PI_ const s_productionInfo[] = 
{
     ...
     {264, 2}, // 1: rules ->  rules rule
     {264, 0}, // 2: rules ->  <empty>
     {265, 4}, // 3: rule (':') ->  name ':' productions ';'
     {265, 2}, // 4: rule (errTok_) ->  errTok_ ';'
     {266, 3}, // 5: productions ('|') ->  productions '|' production
     {266, 1}, // 6: productions ->  production
     {267, 2}, // 7: production (TOKEN) ->  production TOKEN
     {267, 0}, // 8: production ->  <empty>
     {268, 1}, // 9: name (NAME) ->  NAME
     {269, 1}, // 10: rules_$ ->  rules
};
...
#line 26 "grammar"
        {
         d_val_ = addToRules(vs_(0).get<Tag_::RULE>());
         }
        break;
...
#line 38 "grammar"
        {
         d_val_ = Rule{vs_(-3).get<Tag_::STRING>(), vs_(-1).get<Tag_::PRODUCS>()};
         }
        break;
...
#line 47 "grammar"
        {
         d_val_ = addToProductions(vs_(-2).get<Tag_::PRODUCS>(), vs_(0).get<Tag_::PRODUC>());
         }
        break;
...
#line 52 "grammar"
        {
         d_val_ = std::vector<Production>{vs_(0).get<Tag_::PRODUC>()};
         }
        break;
...
#line 59 "grammar"
        {
         d_val_ = addToProduction(vs_(-1).get<Tag_::PRODUC>());
         }
        break;
