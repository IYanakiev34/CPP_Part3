// Generated by Bisonc++ V6.04.03 on Tue, 04 Apr 2023 13:44:05 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {264, 3}, // 17: expr (LSHIFT) ->  expr LSHIFT expr
     {264, 3}, // 18: expr (RSHIFT) ->  expr RSHIFT expr
     {264, 2}, // 19: expr (uMinus) ->  '-' expr
     {264, 2}, // 20: expr ('~') ->  '~' expr
     {264, 3}, // 21: expr ('=') ->  expr '=' expr
     {264, 4}, // 22: expr ('=') ->  expr '+' '=' expr
     {264, 4}, // 23: expr ('=') ->  expr '-' '=' expr
     {264, 4}, // 24: expr ('=') ->  expr '*' '=' expr
     {264, 4}, // 25: expr ('=') ->  expr '/' '=' expr
     {264, 4}, // 26: expr ('=') ->  expr '%' '=' expr
     {264, 4}, // 27: expr ('=') ->  expr LSHIFT '=' expr
     {264, 4}, // 28: expr ('=') ->  expr RSHIFT '=' expr
     {264, 4}, // 29: expr ('=') ->  expr '&' '=' expr
     {264, 4}, // 30: expr ('=') ->  expr '^' '=' expr
     {264, 4}, // 31: expr ('=') ->  expr '|' '=' expr
     {265, 1}, // 32: lines_$ ->  lines
};
