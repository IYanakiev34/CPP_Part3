// Generated by Bisonc++ V6.04.03 on Tue, 04 Apr 2023 14:03:27 +0200
...
{
    static Tag_ const tag = Tag_::STR;
};

template <>
struct TagOf<double>
{
    static Tag_ const tag = Tag_::FLOAT;
};

template <>
struct TagOf<int>
{
    static Tag_ const tag = Tag_::INTEGRAL;
};

template <>
struct TypeOf<Tag_::STR>
{
    typedef std::string type;
};

template <>
struct TypeOf<Tag_::FLOAT>
{
    typedef double type;
};

template <>
struct TypeOf<Tag_::INTEGRAL>
{
    typedef int type;
};
