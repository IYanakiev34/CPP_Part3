...
PI_ const s_productionInfo[] = 
{
     ...
     {262, 1}, // 2: lines ->  line
     {263, 3}, // 3: line (NAME) ->  NAME ':' bool
     {263, 5}, // 4: line (NAME) ->  NAME ':' TRUE SEPERATOR NUMBER
     {263, 5}, // 5: line (NAME) ->  NAME ':' NUMBER SEPERATOR NUMBER
     {263, 7}, // 6: line (NAME) ->  NAME ':' NUMBER SEPERATOR NUMBER SEPERATOR NUMBER
     {264, 1}, // 7: bool (TRUE) ->  TRUE
     {264, 1}, // 8: bool (FALSE) ->  FALSE
     {265, 1}, // 9: lines_$ ->  lines
};
