// Generated by Flexc++ V2.11.00 on Mon, 20 Mar 2023 12:37:47 +0100
...
{
                                    // If we are in a string, the current
                                    // content of the string
    std::string d_stringContent;
                                    // If we are parsing a RSL, this is the
                                    // delim for that RSL
    std::string d_delim;
    public:
        enum
